...
<body>
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{ url('admin/right') }}">首页</a> &raquo; 系统基本信息
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>PHP运行方式</label><span>apache2handler - php版本{{ phpversion()}}</span>
                </li>
                <li>
                    <label>骑着笨鸟慢慢飞-版本</label><span>v-1.0</span>
                </li>
                <li>
                ...
                <li>
                    <label>Host</label><span>{{$_SERVER['REDIS_HOST']}}</span>
                </li>
            </ul>
        </div>
    </div>
