...
<body>
	...
	<div class="top_box">
		<div class="top_left">
			...
			<ul>
				...
				<li><a href="{{url('admin/index')}}" target="main">管理页</a></li>
			</ul>
		</div>
		<div class="top_right">
			<ul>
				<li>管理员：{{$name}}</li>
				<li><a href="{{asset('admin/edtpwd')}}" target="main">修改密码</a></li>
				<li><a href="{{asset('admin/loginout')}}">退出</a></li>
			</ul>
		</div>
	</div>
	<!--头部 结束-->
	...
	<!--主体部分 开始-->
	<div class="main_box">
		<iframe src="{{ asset('admin/right')}}" frameborder="0" width="100%" height="100%" name="main"></iframe> 
	</div>
	<!--主体部分 结束-->
